...
public class TestCourseDAO {
	...
	@Test
	void testFindByIdReturnsCourseDAO() {
	...
	@Test
	void testFindAllDAO() {
		List<Course> storedCourses = courseDAO.findAll();
	...
	@Test
	void testFindByInstructorLoginDAO() {
		List<Course> storedCourses = courseDAO.findCourseByInstructorLogin("christos");
		Assertions.assertNotNull(storedCourses);
		...
		storedCourses = courseDAO.findCourseByInstructorLogin("makis");
		Assertions.assertNotNull(storedCourses);
	...
	void testDeleteDAO() {
		...
		storedCourse = courseDAO.findById(4);
