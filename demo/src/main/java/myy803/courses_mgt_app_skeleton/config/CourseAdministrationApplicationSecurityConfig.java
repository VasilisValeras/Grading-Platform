...
@Configuration
@EnableWebSecurity
public class CourseAdministrationApplicationSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		 ...
		 */
		.and() 
		.formLogin().defaultSuccessUrl("/static/index")
; // specifically this method tells spring to generate a default login page
